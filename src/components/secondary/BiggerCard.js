...
function BiggerCard(props) {
  return (
    <div style={{marginTop:"13.4vh",marginLeft:'26.5vw'}}>
      <h3 style={{marginLeft:'0vw',color:'rgb(255,0,77)'}}>Now Playing</h3>
      <div style={{ height: '41vh', width: '69.3vw', borderRadius:'10px',backgroundImage: `url(${props.imageURL} `,backgroundPosition:`85% 20%`}}>
