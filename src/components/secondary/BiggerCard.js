...
function BiggerCard(props) {
  return (
    <div style={{marginTop:"13.4vh",marginLeft:'27vw'}}>
      ...
      <div style={{ height: '41vh', width: '69.8vw', borderRadius:'10px',backgroundImage: `url(${props.imageURL} `,backgroundPosition:`75% 35%`}}>
        <div style={{ backgroundColor: 'rgba(0,0,0,0)' }} className="card-body">
        <h1 id="title" style={{margin:'15% 0% 0% 23%',backgroundColor:'transparent',fontSize:'7vw'}} >{props.title}</h1>
        </div>
