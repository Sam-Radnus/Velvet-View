...
function MidCard(props) {
    ...
    return (
        <div style={{marginTop:'0vh',marginRight:"5px",cursor:'pointer',width:"fit-content"}}  onClick={()=>{media?navigate(`/${Medium}/${Feature}/Details/${media}/${id}`):navigate(`/${Medium}/${Feature}/Details/${id}`)}}>
           
            <div style={{ backgroundPosition:"45% 20%",height: '157px', width: '210px', position:'relative',overflow:'hidden',borderRadius: '10px', background:props.imageURL!==null?`url(${props.imageURL} `:`url(https://icon-library.com/images/netflix-icon-21_84051.jpg)` }}>
